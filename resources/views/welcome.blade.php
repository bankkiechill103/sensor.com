...
@section('content')
  <div class="container-fluid stylesheetmain">
    <div class="row">
      ...
      <div class="col-12 col-md-6">
        <div class="row mt-5">
          <div class="col-12 text-center">
            <img id="img1" class="main_img" src="{{ asset('images/121642.jpg') }}" alt="จุดที่ 1 ภายในพื้นที่โครงการด้านติด CE เดิม" style="height: 500px; display:none;">
            <img id="img2" class="main_img" src="{{ asset('images/121643.jpg') }}" alt="จุดที่ 1 ภายในพื้นที่โครงการด้านติด CE เดิม" style="height: 500px; display:none;">
            <img id="img3" class="main_img" src="{{ asset('images/121644.jpg') }}" alt="จุดที่ 1 ภายในพื้นที่โครงการด้านติด CE เดิม" style="height: 500px; display:none;">
            <img id="img4" class="main_img" src="{{ asset('images/121645.jpg') }}" alt="จุดที่ 1 ภายในพื้นที่โครงการด้านติด CE เดิม" style="height: 500px; display:none;">
            <img id="img5" class="main_img" src="{{ asset('images/121641.jpg') }}" alt="จุดที่ 1 ภายในพื้นที่โครงการด้านติด CE เดิม" style="height: 500px; display:none;">
          </div>
        </div>
        <div class="row mt-5">
          <div class="col-12">
  ...
  <input type="hidden" name="" value="{{ route('getmap') }}" id="url_load_map">
@stop
